    ...
    <Fragment>
      ...
      <ol type="a">
        <li>
          ...
          materials (information or software) on Better Sports's web site for
        ...
        <li>
          ...
          restrictions and may be terminated by Better Sports at any time. Upon
      ...
      <ol type="a">
        <li>
          The materials on Better Sports's web site are provided "as is". Better
          Sports makes no warranties, expressed or implied, and hereby disclaims
          and negates all other warranties, including without limitation,
          implied warranties or conditions of merchantability, fitness for a
          particular purpose, or non-infringement of intellectual property or
          other violation of rights. Further, Better Sports does not warrant or
      ...
      <p>
        In no event shall Better Sports or its suppliers be liable for any
        damages (including, without limitation, damages for loss of data or
        profit, or due to business interruption,) arising out of the use or
        inability to use the materials on Better Sports's Internet site, even if
        Better Sports or a Better Sports authorized representative has been
      ...
      <p>
        The materials appearing on Better Sports's web site could include
        technical, typographical, or photographic errors. Better Sports does not
        warrant that any of the materials on its web site are accurate,
        complete, or current. Better Sports may make changes to the materials
        contained on its web site at any time without notice. Better Sports does
      ...
      <p>
        Better Sports has not reviewed all of the sites linked to its Internet
        web site and is not responsible for the contents of any such linked
        site. The inclusion of any link does not imply endorsement by Better
        Sports of the site. Use of any such linked web site is at the user's own
        risk.
      </p>
      ...
      <p>
        Better Sports may revise these terms of use for its web site at any time
      ...
      <p>
        Any claim relating to Better Sports's web site shall be governed by the
